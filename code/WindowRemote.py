...
class WindowRemote(wx.Dialog):
    ...
    def __init__(self, parent, data):
        ...
        stt2.SetToolTip(wx.ToolTip('Enter the name or the IP address of the remote machine'))
        ...
        stt1.SetToolTip(wx.ToolTip('Enter your user name in the remote machine'))
        ...
        stt6.SetToolTip(wx.ToolTip('Enter a command that will be used as the prefix of the solver executable name'))
