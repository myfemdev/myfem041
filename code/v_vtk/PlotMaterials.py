...
#        self.rens[0].AddActor(self.sbA)
    ...
    def get_materials(self):
        ...
        if materialspath is None:
            ...
            if parsed[0] is None:
                print('Materials Plot: Can not parse "materials" string value')
            if parsed[0] != 2:
                print('Materials Plot: Can not parse "materials" string value: only allows "menu:" prefix')
