...
class PlotReferences(Plot.Plot):
    ...
    def __init__(self, parent):
        ...
        choicesl = ['No labels', 'Selected', 'All']
    ...
    def get_options(self):
        ...
        return {'interactor':True, 'title':'refs.'}
    ...
    def change_range(self, src):
        ...
        #print 'range', range, '->', #code prior version 0.0.1
        logging.debug(range)    
        # no less than 1
        range = (1.0,range[1])
...
# Add the actors to the render
    ...
    def update_widget(self, tuple):
        self.panel_widgets.update_widget_param(self.struct, str(tuple))
