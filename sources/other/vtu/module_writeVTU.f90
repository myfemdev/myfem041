...
!              lib_vtk_io is a creation of stefano.zaghi@gmail.com
!
...
print*, 'Writing a VTU binary file '//trim(ficho)//'...'
end subroutine
...
print*, 'Saving pointdata field '//trim(namef)//'...'
...
print*, 'Saving celldata field '//trim(namef)//'...'
select case(trim(lcase(typef)))
case('scalar')
...
if (cell_type(celldesc, DIM, LNV, LNN, LNE, LNF, CTYPE) /= 0) stop 'writeVTU: cell_type error'
print*, 'Writing a VTU binary file...'
print*, 'Saving mesh data...'
