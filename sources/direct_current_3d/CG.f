      SUBROUTINE CG( N, B, X, WORK, LDW, ITER, RESID,
     $               INFO, xmat, xmatp,mua1,mua2)
*
...
*     ..
*     .. Array Arguments ..
      DOUBLE PRECISION   X( * ), B( * ),  WORK( * ),xmat(*),xmatp(*)
*     ..
...
********
* Anhadido para calcular el primer residuo y parar si es 0
