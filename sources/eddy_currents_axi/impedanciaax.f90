       ...
       if(iopblov.eq.1)then
          do ii =1,num_inputsi
            do ind=1,num_inputsv
                 ...
                 valor_rms =  inputsv(ind)%vrms*dsqrt(2.d0)/(2.d0*pi)
...
!**************************************************************************
!      Solución del problema = baux (solid conductors) +  baux2(stranded/fixed) *
!**************************************************************************         
         do i=1,nver
           baux(i) = baux(i) + baux2(i)
         enddo      
